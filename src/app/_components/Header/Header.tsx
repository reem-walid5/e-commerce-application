    ...
    <div className="container m-auto py-3 flex items-center justify-between">
      <div className="flex items-center gap-5">
        ...
        <div className="flex items-center gap-1">
          ...
          <p className="text-gray-500 text-[14px]">New Arrivals Daily</p>
        </div>
      </div>
      <div className="hidden items-center gap-5 lg:flex">
        <div className="flex items-center gap-1">
          <FaPhoneAlt className="text-[12px] text-gray-500" />
          <p className="text-gray-500 text-[13px]">+1 (800) 123-4567</p>
        </div>
        <div className="flex items-center gap-1">
          <MdEmail className="text-[12px] text-gray-500" />
          <p className="text-gray-500 text-[13px]">support@freshcart.com</p>
        </div>
        <div className="bg-[#15803D] w-0.5 h-5"></div>
        {isUserAuthenticated ? (
          <Link href="/Profile" className="text-gray-500 text-[13px]">{userName}</Link>
        ) : (
